...
# CONFIG_KSU_SUSFS_OPEN_REDIRECT disabled: upstream 50_add_susfs_in_gki-android12-5.10.patch
# (since Aug 2026) references VMA_PAD_START() without defining it, breaking the build.
